// import getChoice from "./usuarios";
// choice = getChoice();

// var choice = require("./usuarios");

// import choice from "./usuarios";
// console.log(choice);

// var choice = document.getElementById("desicion");
// console.log(choice);
...
function moverAnimal(evento) {
    switch(choice) {
        case "vaca":
            moviendoAnimal(vaca.imagen, vaca.nuevaPosicionX, vaca.nuevaPosicionY);
        break;
        case "pollo":
            moviendoAnimal(pollo.imagen, pollo.nuevaPosicionX, pollo.nuevaPosicionY);
        break;
        case "cerdo":
            moviendoAnimal(cerdo.imagen, cerdo.nuevaPosicionX, cerdo.nuevaPosicionY);
        break;

    }
    function moviendoAnimal(imagenGood, newX, newY) {

        switch (evento.keyCode) {
            case teclas.UP:
                papel.drawImage(pantallazo, 0, 0);
                newX = posicionActualX;
                newY = posicionActualY - movimiento;
                papel.drawImage(imagenGood, newX, newY);
                actualizarPosiciones(newX, newY);
                break;
            ...
            case teclas.LEFT:
                papel.drawImage(pantallazo, 0, 0);
                newX = posicionActualX - movimiento;
                newY = posicionActualY;
                papel.drawImage(imagenGood, newX, newY);
                actualizarPosiciones(newX, newY);
                break;
